...
{
	@WrappedBukkitFieldAccessor({@VersionName("networkManager"),@VersionName(minVer=17, value="a",maxVer=19),@VersionName(value="b",minVer=19,maxVer=19.4f),@VersionName(value="@0",minVer=19.4f)})
