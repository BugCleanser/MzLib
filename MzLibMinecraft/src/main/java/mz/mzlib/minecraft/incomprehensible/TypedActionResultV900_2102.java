...
{
    WrapperFactory<TypedActionResultV900_2102<?>> FACTORY = RuntimeUtil.cast(
        WrapperFactory.of(TypedActionResultV900_2102.class));

    @WrapMinecraftMethod({
        @VersionName(name = "getActionResult", end = 1400),
        @VersionName(name = "method_5467", begin = 1400)
    })
    ActionResult getActionResult();

    @WrapMinecraftMethod({
        @VersionName(name = "getObject", end = 1400),
        @VersionName(name = "method_5466", begin = 1400)
    })
    T getValue();
    ...
    class Wrapper<T extends WrapperObject>
    {
        ...
        {
            return new Wrapper<>(
                TypedActionResultV900_2102.newInstance(result, value.getWrapped()), WrapperFactory.of(value));
        }
