...
public interface TextStyle extends WrapperObject
{
    ...
    static TextStyle newInstanceV1600(
    ...
    @WrapConstructor
    TextStyle static$newInstanceV1600_2104(
        TextColorV1600 color,
        Boolean bold,
        Boolean italic,
        Boolean underlined,
    ...
    @VersionRange(begin = 2109)
    @WrapConstructor
    TextStyle static$newInstanceV2109(
        TextColorV1600 color,
        Integer shadowColorV2104,
        Boolean bold,
        Boolean italic,
    ...
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "underline", end = 1400),
        @VersionName(name = "field_11851", begin = 1400)
    })
    ...
    @VersionRange(end = 1600)
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "formatting", end = 1400),
        @VersionName(name = "color", begin = 1400)
    })
    ...
    {
        return checkEmptyV1600(
            newInstanceV1600(
                this.getColor0V1600(), this.getShadowColor(), this.getBold(), this.getItalic(), underlined,
                this.getStrikethrough(), this.getObfuscated(), this.getClickEvent(), this.getHoverEvent(),
                this.getInsertion(), this.getFontV1600()
            ));
    }
    @VersionRange(begin = 1600)
    default TextStyle withStrikethroughV1600(Boolean strikethrough)
    {
        return checkEmptyV1600(
            newInstanceV1600(
                this.getColor0V1600(), this.getShadowColor(), this.getBold(), this.getItalic(), this.getUnderlined(),
                strikethrough, this.getObfuscated(), this.getClickEvent(), this.getHoverEvent(), this.getInsertion(),
                this.getFontV1600()
            ));
    }
    @VersionRange(begin = 1600)
    default TextStyle withObfuscatedV1600(Boolean obfuscated)
    {
        return checkEmptyV1600(
            newInstanceV1600(
                this.getColor0V1600(), this.getShadowColor(), this.getBold(), this.getItalic(), this.getUnderlined(),
                this.getStrikethrough(), obfuscated, this.getClickEvent(), this.getHoverEvent(), this.getInsertion(),
                this.getFontV1600()
            ));
    }
    @VersionRange(begin = 1600)
    ...
    @VersionRange(begin = 1600)
    @WrapMinecraftMethod({
        @VersionName(name = "setHoverEvent", end = 1602),
        @VersionName(name = "withHoverEvent", begin = 1602)
    })
    ...
    default TextStyle withShadowColorV2104(Integer shadowColor)
    {
        return checkEmptyV1600(
            newInstanceV1600(
                this.getColor0V1600(), shadowColor, this.getBold(), this.getItalic(), this.getUnderlined(),
                this.getStrikethrough(), this.getObfuscated(), this.getClickEvent(), this.getHoverEvent(),
                this.getInsertion(), this.getFontV1600()
            ));
    }
    ...
    default TextStyle withParentV_1600(TextStyle parent)
    {
        ...
        result.setStrikethroughV_1600(
            this.getStrikethrough() != null ? this.getStrikethrough() : parent.getStrikethrough());
