...
public interface TextSelector extends WrapperObject, Text
{
    ...
    {
        return FACTORY.getStatic().static$newInstanceV1700(selector, separator);
    }
    @VersionRange(begin=1700)
    ...
    {
        return this.static$newInstance0V1700_1900(selector, separator.map(Text::getWrapped).toOptional());
    }
    @VersionRange(begin=1700, end=1900)
    @WrapConstructor
    TextSelector static$newInstance0V1700_1900(String selector, @SuppressWarnings("OptionalUsedAsFieldOrParameterType") Optional<?> separator0);
    @SpecificImpl("static$newInstanceV1700")
    ...
    default TextSelector static$newInstanceV2102(ParsedSelectorV2102 selector, Option<Text> separator)
    {
