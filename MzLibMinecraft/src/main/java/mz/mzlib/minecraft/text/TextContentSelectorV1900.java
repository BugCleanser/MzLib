...
public interface TextContentSelectorV1900 extends WrapperObject, TextContentV1900
{
    ...
    @VersionRange(end = 2102)
    @WrapConstructor
    TextContentSelectorV1900 static$newInstance0V_2102(
        String selector,
    ...
    @VersionRange(begin = 2102)
    @WrapConstructor
    TextContentSelectorV1900 static$newInstance0V2102(
        ParsedSelectorV2102 selector,
        @SuppressWarnings("OptionalUsedAsFieldOrParameterType") Optional<?> separator);
