...
{
    WrapperFactory<RegistryEntryLookupV1903> FACTORY = WrapperFactory.find(RegistryEntryLookupV1903.class);
    @Deprecated
    @WrapperCreator
    ...
    {
        WrapperFactory<class_7874> FACTORY = WrapperFactory.find(class_7874.class);
        @Deprecated
        @WrapperCreator
