...
public interface Window extends WrapperObject
{
    ...
    @WrapMinecraftMethod({@VersionName(name="onSlotClick", end=900), @VersionName(name="method_3252", begin=900, end=1400), @VersionName(name="onSlotClick", begin=1400, end=1700)})
