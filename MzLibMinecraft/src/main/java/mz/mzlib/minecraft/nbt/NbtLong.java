...
@WrapMinecraftClass({
    ...
    @VersionName(begin = 1400, end = 1605, name = "net.minecraft.nbt.LongTag"),
    @VersionName(begin = 1605, name = "net.minecraft.nbt.NbtLong")
})
public interface NbtLong extends NbtElement
{
    ...
    @WrapMinecraftFieldAccessor({
        ...
        @VersionName(name = "comp_3821", begin = 2105)
    })
    long getValue();
