...
{
    public static final RingDivision<Float> FLOAT = new RingDivision<>(Group.FLOAT_ADDITION, Group.FLOAT_MULTIPLICATION);
    public static final RingDivision<Double> DOUBLE = new RingDivision<>(Group.DOUBLE_ADDITION, Group.DOUBLE_MULTIPLICATION);
