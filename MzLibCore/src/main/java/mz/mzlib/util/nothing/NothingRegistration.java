                        ...
                        for(int j: locating.locations)
                        {
                            ...
                            else
                            {
                                ...
                                if(ni.type()==NothingInjectType.BRTRUE)
                                {
                                    ...
                                    try
                                    {
                                        nothing.getMethod(ni.locateMethodEnd(), NothingInjectLocating.class).invoke(null, locatingEnd);
                                    }
                                    catch(Throwable e)
                                    {
                                        throw RuntimeUtil.sneakilyThrow(e);
                                    ...
                                    mn.instructions.insertBefore(locatingEnd.insns[locatingEnd.locations.iterator().next()], t);
                                }
                                else
                                {
                                ...
                                switch(ni.type())
                                {
                                    ...
                                    case CATCH:
                                        ...
                                        if(locatingEnd.locations.size()!=1)
                                            throw new IllegalStateException();
                                        mn.instructions.insertBefore(locatingEnd.insns[locatingEnd.locations.iterator().next()], il);
