...
@WrapMinecraftClass({
    @VersionName(name = "net.minecraft.inventory.slot.Slot", end = 1400),
    @VersionName(name = "net.minecraft.container.Slot", begin = 1400, end = 1600),
    @VersionName(name = "net.minecraft.screen.slot.Slot", begin = 1600)
})
public interface WindowSlot extends WrapperObject
{
    ...
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "invSlot", end = 1600),
        @VersionName(name = "index", begin = 1600)
    })
    int getIndex();
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "invSlot", end = 1600),
     ...
     */
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "x", end = 1400),
        @VersionName(name = "xPosition", begin = 1400, end = 1600),
        @VersionName(name = "x", begin = 1600)
    })
    int getX();
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "x", end = 1400),
     ...
     */
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "y", end = 1400),
        @VersionName(name = "yPosition", begin = 1400, end = 1600),
        @VersionName(name = "y", begin = 1600)
    })
    int getY();
    @WrapMinecraftFieldAccessor({
        @VersionName(name = "y", end = 1400),
    ...
    @WrapMinecraftMethod({
        @VersionName(name = "setStack", end = 1900),
        @VersionName(name = "setStackNoCallbacks", begin = 1900)
    })
    ...
    @WrapMinecraftMethod({
        @VersionName(name = "getMaxStackAmount", end = 1602),
        @VersionName(name = "getMaxItemCount", begin = 1602)
    })
