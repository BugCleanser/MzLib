...
@WrapMinecraftClass({
    ...
    @VersionName(begin = 1400, end = 1605, name = "net.minecraft.nbt.IntTag"),
    @VersionName(begin = 1605, name = "net.minecraft.nbt.NbtInt")
})
public interface NbtInt extends NbtElement
{
    ...
    @WrapMinecraftFieldAccessor({
        ...
        @VersionName(name = "comp_3820", begin = 2105)
    })
    int getValue();
