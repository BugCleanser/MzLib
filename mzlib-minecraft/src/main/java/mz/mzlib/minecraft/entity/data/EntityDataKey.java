...
@WrapMinecraftClass({
    @VersionName(name = "mz.mzlib.minecraft.entity.data.EntityDataKey$WrappedV_900", remap = false, end = 900),
    @VersionName(name = "net.minecraft.entity.data.TrackedData", begin = 900)
})
public interface EntityDataKey<T> extends WrapperObject
{
    ...
    @WrapMinecraftFieldAccessor({
        ...
        @VersionName(name = "id", begin = 1400)
    })
    int getIndexV900();
