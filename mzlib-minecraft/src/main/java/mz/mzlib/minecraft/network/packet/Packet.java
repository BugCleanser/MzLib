...
@WrapMinecraftClass({
    @VersionName(name = "net.minecraft.network.Packet", end = 1904),
    @VersionName(name = "net.minecraft.network.packet.Packet", begin = 1904)
})
public interface Packet extends WrapperObject
{
    ...
    List<NetworkPhasePacketManagerV_2005> networkPhasePacketManagersV_2005 =
        MinecraftPlatform.instance.getVersion() < 2005 ? Arrays.asList //
            ( //
    ...
    List<NetworkPhaseSidedPacketManagerV2005> networkPhaseSidedPacketManagersV2005 =
        MinecraftPlatform.instance.getVersion() < 2005 ? null : Arrays.asList //
            ( //
                NetworkPlaySidedPacketManagerFactoriesV2005.s2c()
                    .make(ByteBufWithRegistriesV2005.method_56350(MinecraftServer.instance.getRegistriesV1602())), //
                MinecraftPlatform.instance.getVersion() < 2105 ?
                    NetworkPlaySidedPacketManagerFactoriesV2005.c2sV_2105()
                        .make(ByteBufWithRegistriesV2005.method_56350(MinecraftServer.instance.getRegistriesV1602())) :
                    //
                    NetworkPlaySidedPacketManagerFactoriesV2005.c2sV2105()
                        .make(
                            ByteBufWithRegistriesV2005.method_56350(MinecraftServer.instance.getRegistriesV1602()),
                            null
                        ),//
